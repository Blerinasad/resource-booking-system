...
const navItems = [
  ...
  { label: 'Analytics', to: '/dashboard/analytics', icon: BarChart3, adminOnly: true },
  { label: 'Users', to: '/dashboard/users', icon: Users, adminOnly: true },
]
